...
//Note: leave uncommented!!! analogWrite() PWM is not supported in the ESP32 Core
...
//Note: leave commented!!! analogWrite() PWM is not supported in the ESP32 Core
