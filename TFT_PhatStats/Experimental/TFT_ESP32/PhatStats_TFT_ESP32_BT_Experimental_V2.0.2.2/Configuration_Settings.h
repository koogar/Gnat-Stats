...
/*If using a battery or LiPo pack you must take some responsibility, do your research!!!.
  ...
  !!!THE WEMOS LOLIN32, NOT LIMITED TO, APPEARS TO HAVE NO "UNDERVOLTAGE PROTECTON" OR "OVER DISCHARGE PROTECTION" ON THE CHARGING CIRCUIT!!!

  OTHER BOARDS ARE THE SAME!!! USE A LIPO BATTERY WITH BUILT IN PROTECTION, EVEN THEN, BUILT IN PROTECTION IS CONSIDERED A LAST RESORT 
  SAFETY NET OR "BELTS AND BRACERS" APPROACH. YOU MAY GET SOME BENEFITS, OVERVOLTAGE,OVERCURRENT AND SHORT CIRCUIT PROTECTION BUT, USUALLY 
  THE OVER DISCHARGE PROTECTION CUT OFF VOLTAGE IS AROUND 2.4v WHICH IS WAY TOO LOW FOR THE CONTINUED MAINTAINED HEALTH OF THE BATTERY.

  RECOMMENDED OVER DISCHARGE PROTECTION VOLTAGES FOR LiPo's ARE AROUND 2.9 - 3 VOLTS. ALTERNATIVELY USE A BATTERY BANK THROUGH THE USB CONNECTOR
