...
void splashScreen_Circle() {
  ...
  backlightON ();
  tft.drawCircle(136, 120 , 115, ILI9341_RED); // // flash circle surround

  //tft.drawRoundRect  (0, 0  , 240, 320, 8,    ILI9341_RED);

  tft.drawBitmap(62, 15 , HSM_BG_BMP,  142, 128 , ILI9341_WHITE);
  tft.drawBitmap(62, 15 , HSM_BG2_BMP, 142, 128 , ILI9341_RED);
  tft.drawBitmap(62, 15, HSM_BMP,     142, 128 , ILI9341_GREY);

  tft.setCursor(38, 15);
  tft.setTextColor(ILI9341_WHITE);

  tft.setTextSize(3);
  tft.setCursor(104, 135);
  tft.setTextColor(ILI9341_WHITE);
  tft.println("PHAT ");
  tft.setTextSize(3);
  tft.setCursor(96, 155);
  tft.println("TACHO");
...
#ifdef enable_BT
  tft.drawCircle(136, 120 , 115, ILI9341_RED); // // flash circle surround
  tft.drawBitmap(99, 27, WaitingDataBMP_BT, 76, 190, ILI9341_BLUE);

#else // USB
  tft.drawCircle(136, 120 , 115, ILI9341_RED); // // flash circle surround
  tft.drawBitmap(99 , 27, WaitingDataBMP_USB, 76, 190, ILI9341_RED);
#endif
  tft.drawCircle(136 , 120 , 115, ILI9341_RED); // // flash circle surround
#ifdef enable_DualSerialEvent

  tft.drawBitmap(99 , 27, WaitingDataBMP_USB, 76, 190, ILI9341_BLUE);
#endif
