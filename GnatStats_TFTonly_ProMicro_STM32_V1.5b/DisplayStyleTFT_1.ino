...
void DisplayStyleTFT_1 () {
  ...
  /* Position Test*/
  //tft.drawRect(103, 0 , 25, 10, WHITE); // Flash top right corner when updating
  ...
  //tft.fillRect(38, 31,  90, 16, WHITE); // fill CPU Freq live stats section only
